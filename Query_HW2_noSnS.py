...
def get_results(term):
    ...
    file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Indexer_noStemnStop",'r')
    file.seek(start,0)
...
# loading hashtables
doc_dlen_hash=pickle.load( open( "C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Doc_Hash_noStemnStop", "rb" ) )
token_hash=pickle.load( open( "C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Token_Hash_noStemnStop", "rb" ) )
catalog=pickle.load( open( "C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Catalog_noStemnStop", "rb" ) )
...
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\TF_IDF_Scores_noSnS.txt",'a')
file.write(tf_idf_output)
file.close()
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Okapi_BM_25_Scores_noSnS.txt",'a')
file.write(bm25_output)
file.close()
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Unigram_Laplace_Scores_noSnS.txt",'a')

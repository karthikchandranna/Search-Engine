...
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\TF_IDF_Scores.txt",'a')
file.write(tf_idf_output)
file.close()
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Okapi_BM_25_Scores.txt",'a')
file.write(bm25_output)
file.close()
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Unigram_Laplace_Scores.txt",'a')

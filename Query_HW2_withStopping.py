...
def build_queries():
    ...
    for key in q_dict.keys():    
        fin_query=' '.join([word for word in q_dict[key].split() if word not in stop_words])    
...
def get_results(term):
    ...
    file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Indexer_withStopping",'r')
    file.seek(start,0)
...
# loading hashtables
doc_dlen_hash=pickle.load( open( "C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Doc_Hash_withStopping", "rb" ) )
token_hash=pickle.load( open( "C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Token_Hash_withStopping", "rb" ) )
catalog=pickle.load( open( "C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Catalog_withStopping", "rb" ) )
...
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\TF_IDF_Scores_withStopping.txt",'a')
file.write(tf_idf_output)
file.close()
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Okapi_BM_25_Scores_withStopping.txt",'a')
file.write(bm25_output)
file.close()
file=open("C:\\Users\\hp\\Desktop\\IR_Documents\\AP_DATA\\HW2_Data\\Unigram_Laplace_Scores_withStopping.txt",'a')
